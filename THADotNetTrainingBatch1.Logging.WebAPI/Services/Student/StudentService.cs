...
public class StudentService : IStudentService
{
    ...
    private readonly ILogger<StudentService> _logService;


    public StudentService(AppDbContext context,ILogger<StudentService> logService)
    {
        _context = context;
    ...
    public async Task<IEnumerable<StudentResponseModel>> GetAllStudentsAsync()
    {
        ...
        {
            _logService.LogError(ex, "An error occurred while retrieving all students.");
            throw;
        }
    }
    public async Task<StudentResponseModel?> GetStudentByIdAsync(int id)
    {
        ...
        {
            _logService.LogError(ex, $"An error occurred while retrieving student with ID {id}.");
            throw;
        }
    }
    ...
    public async Task<StudentResponseModel> CreateStudentAsync(StudentRequestModel request)
    {
        try
        {
            ...
            _logService.LogInformation($"Student created successfully with Name : {student.StudentName}");
            return new StudentResponseModel
            {
                Id = student.Id,
                StudentName = student.StudentName,
        ...
        {
            _logService.LogError(ex, "An error occurred while creating a new student.");
            throw;
        }
    }
    ...
    public async Task<bool> UpdateStudentAsync(int id, StudentRequestModel request)
    {
        ...
        {
            _logService.LogError(ex, $"An error occurred while updating student with ID {id}.");
            throw;
        }
    }
    ...
    public async Task<bool> DeleteStudentAsync(int id)
    {
        ...
        {
            _logService.LogError(ex, $"An error occurred while deleting student with ID {id}.");
            throw;
        }
    }
